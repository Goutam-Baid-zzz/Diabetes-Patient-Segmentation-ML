...
CLUSTER_INFO = {
    0: {
        ...
        "care_recommendations": [
            ...
            "Structured outpatient visits — monthly minimum",
    ...
    1: {
        ...
        "care_recommendations": [
            "Quarterly diabetes check-ups with preventive focus",
            "Lifestyle and exercise guidance reinforcement",
            "Quarterly foot care and complication screening",
